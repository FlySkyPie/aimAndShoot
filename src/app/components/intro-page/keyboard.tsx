...
export const Keyboard: React.FC<IProps> = ({ onHover }) => {
  return (
    <div className="keyboard-base">
      ...
      <div className="key active" onMouseOver={() => onHover("W")}>
        w
      </div>
      ...
      <div className="key active" onMouseOver={() => onHover("A")}>
        A
      </div>
      <div className="key active" onMouseOver={() => onHover("S")}>
        S
      </div>
      <div className="key active" onMouseOver={() => onHover("D")}>
        D
      </div>
